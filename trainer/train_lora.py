...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Dzeck LoRA Fine-tuning")
    ...
    parser.add_argument("--wandb_project", type=str, default="Dzeck-LoRA", help="Nama proyek pelacakan training")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"Dzeck-LoRA-{args.lora_name}-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LR-{args.learning_rate}"
