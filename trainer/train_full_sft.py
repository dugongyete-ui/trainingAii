...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Dzeck Full SFT")
    ...
    parser.add_argument("--wandb_project", type=str, default="Dzeck-Full-SFT", help="Nama proyek pelacakan training")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"Dzeck-Full-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
